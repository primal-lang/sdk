...
<a href="https://github.com/primal-lang/sdk/releases/tag/v0.4.4"><img src="https://img.shields.io/badge/Latest-0.4.4-blue" /></a>
</p>

# Primal

**TLDR**: Primal is a minimalist functional programming language inspired by Lambda Calculus, designed for educational purposes with a focus on simplicity and immutability.
