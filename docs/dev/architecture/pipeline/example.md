...
**TLDR**: A step-by-step walkthrough of how the Primal compiler transforms source code through all six stages (reader, lexer, parser, semantic analyzer, lowerer, runtime), using a simple program with `square`, `max`, and `main` functions.
...
| Step | Action                           | Result                                                            |
| ---- | -------------------------------- | ----------------------------------------------------------------- |
| 1    | Load standard library signatures | 300+ built-in functions including `*`, `>=`, `if`, `+`, `-`, etc. |
...
| Standard library functions available | 300+                         |
