...
**TLDR**: The source reader converts raw input into a list of `Character` objects with 1-based row/column positions, handling line ending normalization, grapheme clustering for multi-codepoint characters, and shebang skipping.
