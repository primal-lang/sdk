...
```
pattern() = /[a-z]+[0-9]+/
matched() = regex_match("hello123", pattern())
groups() = regex_findAll("abc123def456", /\d+/)
replaced() = regex_replace("hello123", /\d+/, "XXX")
```
