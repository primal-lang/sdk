...
**TLDR**: Records are named-field structures (`record Person(name, age)`) providing a lightweight way to model structured data with dot-access syntax and functional update (`with { field: value }`), offering better semantics than plain maps.
