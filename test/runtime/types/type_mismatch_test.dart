...
void main() {
  ...
  group('Arithmetic Type Mismatches', () {
    test('num.sin with string', () {
      final Runtime runtime = getRuntime('main = num.sin("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.cos with string', () {
      final Runtime runtime = getRuntime('main = num.cos("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.tan with string', () {
      final Runtime runtime = getRuntime('main = num.tan("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.log with string', () {
      final Runtime runtime = getRuntime('main = num.log("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.negative with string', () {
      final Runtime runtime = getRuntime('main = num.negative("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.sign with string', () {
      final Runtime runtime = getRuntime('main = num.sign("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.inc with string', () {
      final Runtime runtime = getRuntime('main = num.inc("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.dec with string', () {
      final Runtime runtime = getRuntime('main = num.dec("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.fraction with string', () {
      final Runtime runtime = getRuntime('main = num.fraction("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.asDegrees with string', () {
      final Runtime runtime = getRuntime('main = num.asDegrees("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.asRadians with string', () {
      final Runtime runtime = getRuntime('main = num.asRadians("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.isEven with string', () {
      final Runtime runtime = getRuntime('main = num.isEven("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.isOdd with string', () {
      final Runtime runtime = getRuntime('main = num.isOdd("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.isZero with string', () {
      final Runtime runtime = getRuntime('main = num.isZero("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.isNegative with string', () {
      final Runtime runtime = getRuntime('main = num.isNegative("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.isPositive with string', () {
      final Runtime runtime = getRuntime('main = num.isPositive("hello")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.max with strings', () {
      final Runtime runtime = getRuntime('main = num.max("a", "b")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.min with strings', () {
      final Runtime runtime = getRuntime('main = num.min("a", "b")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.sum with strings', () {
      final Runtime runtime = getRuntime('main = num.sum("a", "b")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.compare with strings', () {
      final Runtime runtime = getRuntime('main = num.compare("a", "b")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.integerRandom with strings', () {
      final Runtime runtime = getRuntime('main = num.integerRandom("a", "b")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('num.clamp with strings', () {
      final Runtime runtime = getRuntime('main = num.clamp("a", "b", "c")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('String Type Mismatches', () {
    test('str.first with number', () {
      final Runtime runtime = getRuntime('main = str.first(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.last with number', () {
      final Runtime runtime = getRuntime('main = str.last(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.rest with number', () {
      final Runtime runtime = getRuntime('main = str.rest(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.init with number', () {
      final Runtime runtime = getRuntime('main = str.init(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.isEmpty with number', () {
      final Runtime runtime = getRuntime('main = str.isEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = str.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.bytes with number', () {
      final Runtime runtime = getRuntime('main = str.bytes(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.at with numbers', () {
      final Runtime runtime = getRuntime('main = str.at(5, 0)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.compare with numbers', () {
      final Runtime runtime = getRuntime('main = str.compare(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.drop with booleans', () {
      final Runtime runtime = getRuntime('main = str.drop(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.take with booleans', () {
      final Runtime runtime = getRuntime('main = str.take(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.startsWith with numbers', () {
      final Runtime runtime = getRuntime('main = str.startsWith(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.endsWith with numbers', () {
      final Runtime runtime = getRuntime('main = str.endsWith(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('str.match with numbers', () {
      final Runtime runtime = getRuntime('main = str.match(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
    ...
    test('str.removeAt with booleans', () {
      final Runtime runtime = getRuntime('main = str.removeAt(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('List Type Mismatches', () {
    test('list.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = list.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.rest with number', () {
      final Runtime runtime = getRuntime('main = list.rest(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.init with number', () {
      final Runtime runtime = getRuntime('main = list.init(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.at with booleans', () {
      final Runtime runtime = getRuntime('main = list.at(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.concat with numbers', () {
      final Runtime runtime = getRuntime('main = list.concat(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.drop with booleans', () {
      final Runtime runtime = getRuntime('main = list.drop(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.filled with booleans', () {
      final Runtime runtime = getRuntime('main = list.filled(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.insertEnd with numbers', () {
      final Runtime runtime = getRuntime('main = list.insertEnd(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.insertStart with numbers', () {
      final Runtime runtime = getRuntime('main = list.insertStart(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.join with numbers', () {
      final Runtime runtime = getRuntime('main = list.join(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.take with booleans', () {
      final Runtime runtime = getRuntime('main = list.take(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.all with non-list', () {
      final Runtime runtime = getRuntime('main = list.all(5, num.abs)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.any with non-list', () {
      final Runtime runtime = getRuntime('main = list.any(5, num.abs)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.none with non-list', () {
      final Runtime runtime = getRuntime('main = list.none(5, num.abs)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.removeAt with booleans', () {
      final Runtime runtime = getRuntime('main = list.removeAt(true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
    ...
    test('list.indexOf with non-list', () {
      final Runtime runtime = getRuntime('main = list.indexOf(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.set with booleans', () {
      final Runtime runtime = getRuntime('main = list.set(true, true, true)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('list.remove with non-list', () {
      final Runtime runtime = getRuntime('main = list.remove(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  ...
  group('Map Type Mismatches', () {
    test('map.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = map.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('map.removeAt with non-map', () {
      final Runtime runtime = getRuntime('main = map.removeAt(5, "key")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('map.set with non-map', () {
      final Runtime runtime = getRuntime('main = map.set(5, "key", "val")');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Queue Type Mismatches', () {
    test('queue.new with non-list', () {
      final Runtime runtime = getRuntime('main = queue.new(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('queue.isEmpty with number', () {
      final Runtime runtime = getRuntime('main = queue.isEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('queue.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = queue.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('queue.reverse with number', () {
      final Runtime runtime = getRuntime('main = queue.reverse(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Stack Type Mismatches', () {
    test('stack.new with non-list', () {
      final Runtime runtime = getRuntime('main = stack.new(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('stack.isEmpty with number', () {
      final Runtime runtime = getRuntime('main = stack.isEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('stack.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = stack.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('stack.reverse with number', () {
      final Runtime runtime = getRuntime('main = stack.reverse(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Set Type Mismatches', () {
    test('set.new with non-list', () {
      final Runtime runtime = getRuntime('main = set.new(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('set.isEmpty with number', () {
      final Runtime runtime = getRuntime('main = set.isEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('set.isNotEmpty with number', () {
      final Runtime runtime = getRuntime('main = set.isNotEmpty(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('set.intersection with non-sets', () {
      final Runtime runtime = getRuntime('main = set.intersection(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Timestamp Type Mismatches', () {
    test('time.day with number', () {
      final Runtime runtime = getRuntime('main = time.day(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.epoch with number', () {
      final Runtime runtime = getRuntime('main = time.epoch(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.fromIso with number', () {
      final Runtime runtime = getRuntime('main = time.fromIso(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.hour with number', () {
      final Runtime runtime = getRuntime('main = time.hour(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.minute with number', () {
      final Runtime runtime = getRuntime('main = time.minute(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.month with number', () {
      final Runtime runtime = getRuntime('main = time.month(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.second with number', () {
      final Runtime runtime = getRuntime('main = time.second(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.toIso with number', () {
      final Runtime runtime = getRuntime('main = time.toIso(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.year with number', () {
      final Runtime runtime = getRuntime('main = time.year(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.millisecond with number', () {
      final Runtime runtime = getRuntime('main = time.millisecond(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('time.compare with numbers', () {
      final Runtime runtime = getRuntime('main = time.compare(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Vector Type Mismatches', () {
    test('vector.new with non-list', () {
      final Runtime runtime = getRuntime('main = vector.new(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.new with non-numeric elements', () {
      final Runtime runtime = getRuntime('main = vector.new(["hello"])');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.magnitude with non-vector', () {
      final Runtime runtime = getRuntime('main = vector.magnitude(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.normalize with non-vector', () {
      final Runtime runtime = getRuntime('main = vector.normalize(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.add with non-vectors', () {
      final Runtime runtime = getRuntime('main = vector.add(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.sub with non-vectors', () {
      final Runtime runtime = getRuntime('main = vector.sub(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('vector.angle with non-vectors', () {
      final Runtime runtime = getRuntime('main = vector.angle(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  ...
  group('Directory Type Mismatches', () {
    test('directory.name with number', () {
      final Runtime runtime = getRuntime('main = directory.name(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.path with number', () {
      final Runtime runtime = getRuntime('main = directory.path(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.parent with number', () {
      final Runtime runtime = getRuntime('main = directory.parent(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.exists with number', () {
      final Runtime runtime = getRuntime('main = directory.exists(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.create with number', () {
      final Runtime runtime = getRuntime('main = directory.create(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.delete with number', () {
      final Runtime runtime = getRuntime('main = directory.delete(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.list with number', () {
      final Runtime runtime = getRuntime('main = directory.list(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.fromPath with number', () {
      final Runtime runtime = getRuntime('main = directory.fromPath(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.copy with numbers', () {
      final Runtime runtime = getRuntime('main = directory.copy(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.move with numbers', () {
      final Runtime runtime = getRuntime('main = directory.move(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('directory.rename with numbers', () {
      final Runtime runtime = getRuntime('main = directory.rename(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('File Type Mismatches', () {
    test('file.name with number', () {
      final Runtime runtime = getRuntime('main = file.name(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.path with number', () {
      final Runtime runtime = getRuntime('main = file.path(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.parent with number', () {
      final Runtime runtime = getRuntime('main = file.parent(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.exists with number', () {
      final Runtime runtime = getRuntime('main = file.exists(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.create with number', () {
      final Runtime runtime = getRuntime('main = file.create(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.delete with number', () {
      final Runtime runtime = getRuntime('main = file.delete(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.read with number', () {
      final Runtime runtime = getRuntime('main = file.read(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.extension with number', () {
      final Runtime runtime = getRuntime('main = file.extension(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.length with number', () {
      final Runtime runtime = getRuntime('main = file.length(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.fromPath with number', () {
      final Runtime runtime = getRuntime('main = file.fromPath(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.copy with numbers', () {
      final Runtime runtime = getRuntime('main = file.copy(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.move with numbers', () {
      final Runtime runtime = getRuntime('main = file.move(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.rename with numbers', () {
      final Runtime runtime = getRuntime('main = file.rename(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });

    test('file.write with numbers', () {
      final Runtime runtime = getRuntime('main = file.write(5, 5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Environment Type Mismatches', () {
    test('env.get with number', () {
      final Runtime runtime = getRuntime('main = env.get(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Control Flow Type Mismatches', () {
    test('if with non-boolean condition', () {
      final Runtime runtime = getRuntime('main = if (5) "a" else "b"');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('Logic Short-Circuit Type Mismatches', () {
    ...
    test('false or non-boolean', () {
      final Runtime runtime = getRuntime('main = false | 5');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
  ...
  group('JSON Type Mismatches', () {
    test('json.decode with number', () {
      final Runtime runtime = getRuntime('main = json.decode(5)');
      expect(runtime.executeMain, throwsA(isA<InvalidArgumentTypesError>()));
    });
  });
