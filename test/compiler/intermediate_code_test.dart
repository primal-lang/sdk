...
void main() {
  group('IntermediateCode', () {
    test('empty() contains standard library functions', () {
      ...
      expect(code.functions, isNotEmpty);
    ...
    test('empty() includes core library functions', () {
      ...
      expect(code.functions.containsKey('num.add'), isTrue);
      expect(code.functions.containsKey('str.length'), isTrue);
      expect(code.functions.containsKey('list.map'), isTrue);
    });
    ...
    test('user function has correct parameter count', () {
      ...
      final addFn = code.functions['add']!;
    ...
    test('main function node is a CustomFunctionNode', () {
      final code = getIntermediateCode('main = 42');
      final mainFn = code.functions['main']!;

      expect(mainFn, isA<CustomFunctionNode>());
    });

    test('standard library function node is a NativeFunctionNode', () {
      final code = getIntermediateCode('main = 42');
      final numAdd = code.functions['num.add']!;
