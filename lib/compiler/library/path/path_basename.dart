...
class PathBasename extends NativeFunctionTerm {
  ...
  @override
  Term term(List<Term> arguments) => PathBasenameWithArguments(
    name: name,
...
class PathBasenameWithArguments extends NativeFunctionTermWithArguments {
  const PathBasenameWithArguments({
    required super.name,
  ...
  Term reduce() {
    ...
    if (a is StringTerm) {
      final String result = PlatformInterface().path.basename(a.value);
