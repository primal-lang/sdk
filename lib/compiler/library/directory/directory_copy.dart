...
class DirectoryCopy extends NativeFunctionTerm {
  const DirectoryCopy()
    : super(
        name: 'directory_copy',
        parameters: const [
...
class TermWithArguments extends NativeFunctionTermWithArguments {
  ...
  Term reduce() {
    ...
    if ((a is DirectoryTerm) && (b is DirectoryTerm)) {
      final bool copied = PlatformInterface().directory.copy(a.value, b.value);
